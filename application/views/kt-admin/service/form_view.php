...
<!-- Start Forms -->
<form method="post" action="<?php echo site_url('services/create') ?>">
	<div class="grid_6">
		<div class="box-header">New Services</div>
		<div class="box">
			<div class="row">
			...
			<div class="row">
	            ...
	            <textarea id="content" class="tinymce mceEditor" name="service_description" cols="5" rows="15"></textarea>
	        </div>
	        <div class="row">
        ...
        <table cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo word_limiter(strip_tags($data->service_description), 10); ?> [....]</td>
                    <td class="tc">
						...
						<a href="<?php echo site_url('services/delete/'.$data->service_id.''); ?>" title="Delete Data"><img src="<?php //echo load_image('user_delete.png');?>" alt="delete data" border="0"></a></td>
                </tr>
				<?php
					endforeach;
				else :
