...
<head>
   ...
   ================================================== -->
	...
	<!-- CSS
    ================================================== -->
   <link rel="stylesheet" href="<?php echo base_url()?>assets/home/css/base.css">
	<link rel="stylesheet" href="<?php echo base_url()?>assets/home/css/main.css">
   <link rel="stylesheet" href="<?php echo base_url()?>assets/home/css/media-queries.css">         
...
<body class="homepage">
   ...
   <section id="services">
      ...
      <div class="row">
          ...
          <?php foreach($data_service->result() as $service):?>
	      		<div class="bgrid">
   ...
   <section id="contact">
      ...
      <div class="row form-section">
      	...
      	<div id="contact-form" class="twelve columns">
            ...
            <form name="contactForm" id="contactForm" method="post" action="<?php echo site_url('home/contact')?>">
                  ...
                  <div class="row">
	                  ...
	                  <div class="six columns mob-whole">	
	                  	<label for="contactName">Last Name <span class="required">*</span></label>      						   
	      					<input name="contactName" type="text" id="contactLname" placeholder="Last Name" value="" />	      					
	                  </div>	                        
                  ...
                  <div>
                     <input class="submit full-width" value="Send Message" type="submit" name="submit"/>
                     <div id="image-loader">
   ...
   <script>window.jQuery || document.write('<script src="<?php echo base_url()?>assets/home/js/jquery-1.10.2.min.js"><\/script>')</script>
   <script type="text/javascript" src="<?php echo base_url()?>assets/home/js/jquery-migrate-1.2.1.min.js"></script>   
   <script src="<?php echo base_url()?>assets/home/js/jquery.flexslider.js"></script>
   <script src="<?php echo base_url()?>assets/home/js/jquery.fittext.js"></script>
   <script src="<?php echo base_url()?>assets/home/js/backstretch.js"></script> 
